            ...
            OB = {
                ...
                augmentObject: function(r, s) {
                    ...
                    if (overrideList && overrideList !== !0)
                        for (i = 2; i < a.length; i += 1) r[a[i]] = s[a[i]];
                    else {
...
XIAOMI.namespace("app.analytics"), XIAOMI.app.analytics = function(element, options) {
    ...
    function() {
        ...
        for (var lens = historyVal.length - 1, objArr = [], i = 0; lens > i; i++) {
            itemArray = historyVal[i].split(","), goodsUrl = XIAOMI.GLOBAL_CONFIG.itemSite + "/" + itemArray[3] + ".html";
            var pro = {};
        ...
        init: function() {
            var _this = this; - 1 !== window.location.pathname.indexOf("cart") && XIAOMI.app.cookie("userId") && !XIAOMI.app.cookie("xm_order_btauth") && _this._proxyiframe(), $("[data-needLogin='true']").on("click", function() {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    if ($("#J_categoryContainer").find(".nav-category-list").html(templateCategory(categoryTree)), XIAOMI.app.analytics([$(".nav-category-content > a"), $(".nav-category-content .links").find("a"), $(".nav-category-content .children-list").find("a"), $(".nav-category-content .children-special-section").find("a")], {
                        ...
                        }), isCategoryStatic) toggleCategoryList("static");
                    else {
        ...
        function init(elm, opt) {
            ...
            var options, $listWrap, $list, $btnPrev, $btnNext, itemLength, itemWidth, itemHeight, itemPerSlide, countPage, $elm = $(elm),
                curIndex = 0;
            return 0 === $elm.length ? $elm : $elm.length > 1 ? ($elm.each(function() {
                init($(this), opt)
        ...
        updateDom: function(uid) {
            ...
            var timeoutUserMenu, staticUrl = XIAOMI.GLOBAL_CONFIG.staticSite ? XIAOMI.GLOBAL_CONFIG.staticSite : "http://static.mi.com",
